...
public class AgeDatePicker extends DatePickerButton
{
    private PersonCreationFragmentBinding binding;
    public AgeDatePicker(FragmentActivity activity, PersonCreationFragmentBinding binding) {
        super(activity);
    ...
    public void onDateSet(DatePicker datePicker, int i, int i1, int i2) {
        ...
        binding.ageInput.setText(String.format("%02d.%02d.%02d", i2, i1 + 1, i));
    }
}
